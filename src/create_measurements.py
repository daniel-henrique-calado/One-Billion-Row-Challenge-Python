...
def build_test_data(weather_station_names, num_rows_to_create):
    ...
    print('Creating file ... it will some time ...')
    ...
    print("File created 'data/measurements.txt' successfully.")
    print(f"File size:  {human_file_size}")
...
def main():
    ...
    """
    num_rows_to_create = int(input("One Billion Rows Challenge. Enter the number of rows to start (Example: 1_000_000_000): "))
